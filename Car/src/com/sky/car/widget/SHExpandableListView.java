...
public class SHExpandableListView extends ExpandableListView implements OnScrollListener{
	/**  显示格式化日期模板   */
	...
	public SHExpandableListView(Context pContext) {
		super(pContext);
		// TODO Auto-generated constructor stub
		init(pContext);
	}
	public SHExpandableListView(Context pContext, AttributeSet pAttrs) {
		super(pContext, pAttrs);
		init(pContext);
	}

	public SHExpandableListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
...
//		}
	...
	@Override
	public void onScroll(AbsListView view, int pFirstVisibleItem,
